...
-- Run this in your Supabase SQL Editor to immediately fix the recursion issue
...
-- Step 4: Test that tables are accessible
SELECT 'RLS Disabled Successfully' as status, COUNT(*) as user_count FROM users;
SELECT 'RLS Disabled Successfully' as status, COUNT(*) as book_count FROM books;
SELECT 'RLS Disabled Successfully' as status, COUNT(*) as student_count FROM students;
SELECT 'RLS Disabled Successfully' as status, COUNT(*) as supplier_count FROM suppliers;
